...
export default function LastUnit({ contents, clicked, selectedTo, selectedFrom, setSelectedTo }) {
  return (
    <select name="cars" className="w-28 max-[520px]:w-full h-12 rounded-lg px-2 bg-gray-700 text-white focus:shadow-xl cursor-pointer transition-all duration-150 hover:brightness-90" onChange={(e) => setSelectedTo(e.target.value)} value={selectedTo} 
