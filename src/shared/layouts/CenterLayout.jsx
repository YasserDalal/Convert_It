  ...
  return (
    <div className={className}>
      <div className="flex justify-between items-center max-[1344px]:flex-col min-w-[320px] w-full px-28 max-[1344px]:px-0 relative">
        ...
        <ResultContent classname={"absolute -bottom-44 left-10 right-10 max-[1344px]:bottom-[30%] max-[1344px]:static max-[1344px]:left-0 max-[1344px]:right-0 max-[11344px]:pb-14  flex justify-center"} result={result} finalInputValue={finalInputValue} finalSecondInput={finalSecondInput} clicked={clicked} bmi={bmi}/>
